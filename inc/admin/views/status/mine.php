                ...
                <div class="form-wrap">
                    ...
                    <form id="vca-add-status" method="post">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" name="name" id="status-name" class="VCA-Vazir" placeholder="نام وضعیت" required pattern="[آ-ی ]+" value="">
                        </div>
                        <div class="form-field">
                            <label for="status-icon" class="VCA-Vazir">آیکون</label>
                            <input type="text" name="icon" id="status-icon" class="VCA-Vazir" placeholder="ip-ar-message-exclamation" value="">
                        </div>
                        <div class="form-field">
                                ...
                                <tr style="font-size: 18px;">
                                    <td>
                                        ...
                                        <div class="row-actions">
                                            ...
                                            <span class="delete VCA-Vazir"><a href="<?php echo wp_nonce_url(admin_url('admin.php?page=VCA-status&action=delete&id=' . $status->ID), 'delete_status', 'delete_status_nonce') ?>">حذف</a></span>
                                        </div>
                                    </td>
