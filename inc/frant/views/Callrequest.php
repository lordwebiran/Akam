...
class VC_Order_Manager_admin
{
    ...
    public function __construct()
    {
        global $wpdb;
        $this->wpdb = $wpdb;
        $this->table = $wpdb->prefix . 'VC_orders';
        $this->product = $this->wpdb->prefix . 'VC_product';
        $this->product_type = $this->wpdb->prefix . 'VC_product_type';
        $this->sale_type = $this->wpdb->prefix . 'VC_purchase_sale_type';
        $this->order_status = $this->wpdb->prefix . 'VC_order_status';
